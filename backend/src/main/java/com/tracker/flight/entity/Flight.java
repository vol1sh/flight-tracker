...
public class Flight {
    ...
    @Column(name = "departure_iata", nullable = false, length = 5)
    private String departureIata;

    @Column(name = "arrival_iata", nullable = false, length = 5)
    ...
    public Flight(Long id, String flightIata, String departureIata, String arrivalIata,
    ...
    public static class Builder {
        ...
        public Flight build() {
            return new Flight(id, flightIata, departureIata, arrivalIata,
